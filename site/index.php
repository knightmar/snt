...
<section class="content">
    ...
    <p id="desc">Le Studio Ghibli Inc. <i>(株式会社スタジオジブリ, Kabushiki gaisha sutajio Jiburi)</i> est un studio d'animation
        ...
        logo du studio est une représentation de Totoro, une créature apparue dans <a href="/site/pages/films/tonari_no_totoro.php">Mon voisin Totoro</a>, l'un des films
